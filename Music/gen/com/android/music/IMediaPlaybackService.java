 ...
 * Original file: C:\\Documents and Settings\\yang.li2\\Desktop\\debug\\Music\\src\\com\\android\\music\\IMediaPlaybackService.aidl
 */
...
case TRANSACTION_removeTrackInMainThread:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
this.removeTrackInMainThread(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public void removeTrackInMainThread(long id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(id);
mRemote.transact(Stub.TRANSACTION_removeTrackInMainThread, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_removeTrackInMainThread = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
...
public void removeTrackInMainThread(long id) throws android.os.RemoteException;
}

...
public class AudioPreviewStarter extends Activity
    ...
    private void checkDrmRightStatus(Uri uri, int drmMethod) {
        ...
        try {
            rightsStatus = drmClient.checkRightsStatusForTap(uri, DrmStore.Action.PLAY);
        ...
        switch (rightsStatus) {
            case DrmStore.RightsStatus.RIGHTS_VALID:
                drmClient.showConsumeDialog(this, this, this);
                break;
            case DrmStore.RightsStatus.RIGHTS_INVALID:
                drmClient.showLicenseAcquisitionDialog(this, uri, this);
                if (method == DrmStore.DrmMethod.METHOD_CD) {
                    finish();
                }
                break;
            case DrmStore.RightsStatus.SECURE_TIMER_INVALID:
                drmClient.showSecureTimerInvalidDialog(this, null, this);
                break;
            default:
                break;
        }

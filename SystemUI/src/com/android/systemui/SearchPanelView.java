...
public class SearchPanelView extends FrameLayout implements
	...
	//GPBYB-362 liyang 20130924 change "final boolean show" to "boolean show"
    public void show(boolean show, boolean animate) {
		//GPBYB-362 liyang 20130924 add start
		if (FeatureOption.RLK_GP818H_A1_SN_SUPPORT){
			show = false;
			animate = false;
		}
		//GPBYB-362 liyang 20130924 add end

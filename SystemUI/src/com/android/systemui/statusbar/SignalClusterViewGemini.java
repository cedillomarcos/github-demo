        ...
        if (mMobileVisible) {
            ...
            if (isSimInserted(PhoneConstants.GEMINI_SIM_1)
                ...
                if (simColorId > -1 && simColorId < 4 && mDataNetType != null) {
					...
					//add GPBYL-120 wangxiaobo 20130520(start)
					   switch(mDataNetType){
			            case Type_G:
			            	id = TelephonyIconsGemini.NETWORKTYE_G[simColorId];
			            	break;
			            case Type_3G:
			            	id = TelephonyIconsGemini.NETWORKTYE_3G[simColorId];
			            	break;
			            case Type_1X:
			            	id = TelephonyIconsGemini.NETWORKTYE_1X[simColorId];
			            	break;
			            case Type_1X3G:
			            	id = TelephonyIconsGemini.NETWORKTYE_1X_3G[simColorId];
			            	break;
			            default:
			            	id = 0;
			          }
					//add GPBYL-120 wangxiaobo 20130520(end)

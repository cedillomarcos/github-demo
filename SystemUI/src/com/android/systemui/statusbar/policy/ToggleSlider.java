...
//GPBYL-543 liyang 20130605 (on)
import android.hardware.SensorManager;
import android.hardware.Sensor;
//GPBYL-543 liyang 20130605 (off)
...
public class ToggleSlider extends RelativeLayout 
    ...
    public ToggleSlider(Context context, AttributeSet attrs, int defStyle) {
        ...
        //GPBYL-543 liyang 20130605 (on)
	if(!isLightSensorSupport(context)){
        	View.inflate(context, R.layout.status_bar_toggle_slider_no_light_sensor, this);
	}else{
    ...
    //GPBYL-543 liyang 20130605 (on)
    private boolean isLightSensorSupport(Context context) {

...
import com.android.settings.ext.IWifiApDialogExt;
...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mWifiConfig != null) {
            ...
            // GPBLJ-81 chenbo 20130507 (start)
            mSsid.setSelection(mSsid.getText().length());
            // GPBLJ-81 chenbo 20130507 (end)
            /// M: set selection @{
            if (mWpaNonsupport) {
                if (isWpa2Only()) {

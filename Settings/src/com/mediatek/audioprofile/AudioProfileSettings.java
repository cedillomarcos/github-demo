...
import com.android.settings.ext.IAudioProfileExt;
...
public class AudioProfileSettings extends SettingsPreferenceFragment implements
    ...
    private static final String AUDIO_PROFILE_MENUID = "audioprofilemenuid";
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       if (savedInstanceState != null) {
            mMenuId = savedInstanceState.getInt(AUDIO_PROFILE_MENUID, mMenuId);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(AUDIO_PROFILE_MENUID, mMenuId);
    }
        ...
        if (id == DIALOG_NAME) {
            ...
            if (mEditText != null) {
                ...
                mEditText.setText(mMenuId == MENUID_ADD ? ""
                        : mRenameDialogtext);
				//add by wangxiaobo GPBYL-47 20130514(start)
				  if(mMenuId != MENUID_ADD){
					mEditText.setSelection(mRenameDialogtext.length());
				  }
				//add by wangxiaobo GPBYL-47 20130514(start)
            }

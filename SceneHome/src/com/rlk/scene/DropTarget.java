...
public interface DropTarget {
    ...
    void onDragOver(DragSource source, int x, int y, int xOffset, int yOffset, Object dragInfo, boolean isDrop);

    void onDragExit(DragSource source, int x, int y, int xOffset, int yOffset, Object dragInfo);
    
    void onCompleteTranslate(DragSource source, int x, int y, int xOffset, int yOffset, Object dragInfo);

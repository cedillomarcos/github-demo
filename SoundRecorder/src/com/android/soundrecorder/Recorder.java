...
public class Recorder implements MediaRecorder.OnErrorListener {
    ...
    public void onError(MediaRecorder recorder, int errorType, int extraCode) {
        LogUtils.i(TAG, "<onError> errorType = " + errorType);
        LogUtils.i(TAG, "<onError> extraCode = " + extraCode);
        stopRecording();
    ...
    public boolean stopRecording() {
        ...
        if ((SoundRecorderService.STATE_PAUSE_RECORDING != mCurrentState && SoundRecorderService.STATE_RECORDING != mCurrentState)
                || null == mRecorder) {

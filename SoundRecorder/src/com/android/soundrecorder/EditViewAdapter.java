...
public class EditViewAdapter extends BaseAdapter {
    ...
    protected List<Integer> getCheckedPosList() {
        ...
        for (int i = 0; i < listSize; i++) {
            if (mCheckStates.valueAt(i) && !mCheckedItemId.contains(mCheckStates.keyAt(i))) {
    ...
    protected ArrayList<String> getCheckedItemsList() {
        ...
        for (int i = 0; i < listSize; i++) {
            if (mCheckStates.valueAt(i)) {
                checkedItemsList.add(mPathList.get(getItemPos(mCheckStates.keyAt(i))));
            }
        }
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        if (null == editListItemView) {
            ...
            editViewTag = new EditViewTag((TextView) editListItemView
                    .findViewById(R.id.record_file_name), (CheckBox) editListItemView
                    .findViewById(R.id.record_file_checkbox), (TextView) editListItemView
                    .findViewById(R.id.record_file_title), (TextView) editListItemView
    ...
    static class EditViewTag {
         ...
         */
        public EditViewTag(TextView name, CheckBox box, TextView title, TextView duration) {
            this.mName = name;
            this.mCheckBox = box;
            this.mTitle = title;

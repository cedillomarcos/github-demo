...
public class EncapsulatedTelephonyService {
   ...
   */
    ...
    */
   public boolean isPhbReady() throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.isPhbReady();
       } else {
           return false;
       }
   }
   ...
   /**
     ...
     *
    */
   public boolean isPhbReadyGemini(int simId) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.isPhbReadyGemini(simId);
       } else {
           return false;
       }
   }
   ...
   public String getInterfaceName(String apnType) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.getInterfaceName(apnType);
       } else {
           return null;
       }
   }

   public String getIpAddress(String apnType) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.getIpAddress(apnType);
       } else {
           return null;
       }
   }

   public String getGateway(String apnType) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.getGateway(apnType);
       } else {
           return null;
       }
   }

   public String getInterfaceNameGemini(String apnType, int slot) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.getInterfaceNameGemini(apnType, slot);
       } else {
           return null;
       }
   }

   public String getIpAddressGemini(String apnType, int slot) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.getIpAddressGemini(apnType, slot);
       } else {
           return null;
       }
   }

   public String getGatewayGemini(String apnType, int slot) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.getGatewayGemini(apnType, slot);
       } else {
           return null;
       }
   }

   public int[] getAdnStorageInfo(int simId) throws android.os.RemoteException {
       if (EncapsulationConstant.USE_MTK_PLATFORM) {
           return sTelephony.getAdnStorageInfo(simId);
       } else {
           return null;
       }
   }

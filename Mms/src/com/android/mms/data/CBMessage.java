...
public class CBMessage {
    ...
    // Query all URI
    private static final Uri ALL_MESSAGE_URI = EncapsulatedTelephony.CbSms.CONTENT_URI;
    ...
    private static final String[] ALL_MESSAGE_PROJECTION = { "_id",
            EncapsulatedTelephony.CbSms.SIM_ID, EncapsulatedTelephony.CbSms.CHANNEL_ID,
            EncapsulatedTelephony.CbSms.BODY, EncapsulatedTelephony.CbSms.READ,
            EncapsulatedTelephony.CbSms.DATE, EncapsulatedTelephony.CbSms.THREAD_ID };
    private static final String[] ALL_CHANNEL_PROJECTION = { "_id",
            EncapsulatedTelephony.CbSms.CbChannel.NAME,
            EncapsulatedTelephony.CbSms.CbChannel.NUMBER };
    ...
    public static void startQueryForAll(AsyncQueryHandler handler, int token) {
        ...
        handler.startQuery(token, null, ALL_MESSAGE_URI, ALL_MESSAGE_PROJECTION,
                null, null, EncapsulatedTelephony.CbSms.DEFAULT_SORT_ORDER);
    }

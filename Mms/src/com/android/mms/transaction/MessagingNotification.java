...
//add by wangxiaobo GPBYL-80 20130515(satrt)
import android.os.PowerManager;
//add by wangxiaobo GPBYL-80 20130515(end)
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                if (ipMessageId > 0) {
                    ...
                    IpMessage ipMessage = MessageUtils.getMessageManager(context).getIpMsgInfo(messageId);
                    if (null != ipMessage) {
...
//add by wangxiaobo GPBYL-80 20130515(satrt)
		if(isNew){
			...
			PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "bright screen");
...
//add by wangxiaobo GPBYL-80 20130515(end)
    ...
    protected static CharSequence buildTickerMessage(
        ...
        if (MessageUtils.getServiceManager(context).getIpMessageServiceId() > 0
                && address.startsWith(IpMessageConsts.GROUP_START)) {
            displayAddress = MessageUtils.getContactManager(context).getNameByNumber(address);

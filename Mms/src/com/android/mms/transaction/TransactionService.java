        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case EVENT_DATA_STATE_CHANGED:
                    ...
                    if (EncapsulatedFeatureOption.MTK_GEMINI_SUPPORT) {
                        if (EncapsulatedPhone.GEMINI_SIM_1 == slotOfInfo || EncapsulatedPhone.GEMINI_SIM_2 == slotOfInfo) {
                    ...
                    if (EncapsulatedFeatureOption.MTK_GEMINI_SUPPORT) {
                        if (EncapsulatedPhone.GEMINI_SIM_1 == slotOfInfo || EncapsulatedPhone.GEMINI_SIM_2 == slotOfInfo) {
                            ...
                            if (null == si) {
                                MmsLog.e(MmsApp.TXN_TAG, "TransactionService:SIMInfo is null for slot " + slotOfInfo);
                                return;
                            }
                            int simId = (int)si.getSimId();
                ...
                case EVENT_SCAN_PENDING_MMS:
                    ...
                    if (EncapsulatedFeatureOption.MTK_GEMINI_SUPPORT) {
                        ...
                        int secondSlot;
                        if (firstSlot == EncapsulatedPhone.GEMINI_SIM_1) {
                            secondSlot = EncapsulatedPhone.GEMINI_SIM_2;
                        } else {
                            secondSlot = EncapsulatedPhone.GEMINI_SIM_1;
                        }
                        MmsLog.d(MmsApp.TXN_TAG, "scan first slot:"+firstSlot+",second slot:"+secondSlot);

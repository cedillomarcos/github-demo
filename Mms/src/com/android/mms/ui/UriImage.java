...
public class UriImage {
    ...
    private void buildSrcFromPath() {
        ...
        // before saveDraft @{
        EncapsulatedStorageManager mStorageManager = new EncapsulatedStorageManager(mContextTemp);
        File mTempFile = mStorageManager.getMTKExternalCacheDir(mContextTemp.getPackageName());

...
public class MultiDeleteActivity extends ListActivity implements IMmsMultiDeleteAndForwardHost, INotificationsListener {
    ...
    public static final String ISMS_TAG = "Mms/isms/MultiDeleteActivity";
...
//    private TextView mActionBarText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MmsConfig.getIpMessagServiceId(this) == IpMessageServiceId.ISMS_SERVICE) {
            MmsLog.d(ISMS_TAG, "onCreate(): is ip service ready ?= "
                    + MessageUtils.getServiceManager(this).serviceIsReady());
            if (!MessageUtils.getServiceManager(this).serviceIsReady()) {
                MmsLog.d(ISMS_TAG, "Turn on iSMS service by ConversationList.");
    ...
    private void initPlugin(Context context) {
        try {
            mMmsDeleteAndForwardPlugin = (IMmsMultiDeleteAndForward)EncapsulatedPluginManager.createPluginObject(context, IMmsMultiDeleteAndForward.class.getName());
            mOP01Plugin = true;
...
*/
    ...
    private void markCheckedState(boolean checkedState) {
        ...
        int locked = 0;
        if (checkedState && cursor != null && cursor.moveToFirst()) {
            do {
                Map.Entry<Long, Boolean> entry = (Entry<Long, Boolean>) iter.next();
                if (entry.getValue()) {
                    ...
                    if (mMmsId < 0) {
                        ...
                        if (cursor.getInt(mMsgListAdapter.COLUMN_MMS_MESSAGE_TYPE) == PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND) {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        if (hasFocus) {
            /// M: add for iSMS, remove mark as read
                ...
                if ((!mHasLockedMsg) || (mDeleteLockedMessages && mHasLockedMsg)) {
                      new Thread(new Runnable() {
                        public void run() {
                            ...
                            MessageUtils.deleteIpMessage(MultiDeleteActivity.this, threads, mDeleteLockedMessages, mMaxSmsId);
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    if (mSelectedIpMessageIds.size() > 0) {
                        ...
                        MessageUtils.getMessageManager(MultiDeleteActivity.this)
        ...
        public void handleMessage(Message msg) {
            ...
            case SHOW_DOWNLOAD_PROGRESS_BAR:
                if (mDownloadDialog == null) {
                    ...
                    mDownloadDialog.setMessage(MultiDeleteActivity.this.getString(R.string.str_ipmsg_download_history_dlg));
                ...
                for (MessageItem item : mSelectedIpAttachMessageItem) {
                    ...
                    if (item.mIpMessage != null && item.mIpMessage instanceof IpAttachMessage) {
                        ...
                        if (ipAttachMessage.isInboxMsgDownloalable() &&
                            !MessageUtils.getMessageManager(MultiDeleteActivity.this).isDownloading(item.mMsgId)) {
                            MessageUtils.getMessageManager(MultiDeleteActivity.this).downloadAttach(item.mMsgId);
...
//            R.plurals.message_view_selected_message_count, selectNum, selectNum));
    ...
    private ArrayList<Long> recordIdList = new ArrayList<Long>();
    ...
    private class SelectActionMode implements ActionMode.Callback {
        ...
        public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
            ...
            MmsLog.d(ISMS_TAG, "onPrepareActionMode(): mImportantCount = " + mImportantCount);
...
//            }
        ...
        private void showIpMessageDownloadDialog(final ActionMode mode, final MenuItem item) {
            ...
            builder.setTitle(R.string.download)
                   ...
                   .setNegativeButton(R.string.Cancel, null)
                   .setMessage(R.string.multi_forward_tips_content)
                   .show();
        }
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            case R.id.forward:
                ...
                if (MessageUtils.getIpMessagePlugin(MultiDeleteActivity.this).isActualPlugin()) {
                    ...
                    if (MessageUtils.getServiceManager(MultiDeleteActivity.this)
                        ...
                        try {
                            ...
                            intent.putExtra(RemoteActivities.KEY_REQUEST_CODE,
                                ComposeMessageActivity.REQUEST_CODE_ISMS_PICK_CONTACT);
                            intent.putExtra(RemoteActivities.KEY_TYPE, SelectContactType.ALL);
                            MessageUtils.startRemoteActivityForResult(MultiDeleteActivity.this,
                                intent);
                        } catch (ActivityNotFoundException e) {
                            Toast.makeText(MultiDeleteActivity.this, MultiDeleteActivity.this.getString(R.string.no_application_response),
                                Toast.LENGTH_SHORT).show();
...
//            setMarkState(false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case ComposeMessageActivity.REQUEST_CODE_ISMS_PICK_CONTACT:
                String selectedContactsNums = data
                        .getStringExtra(MessageUtils.SELECTION_CONTACT_RESULT);
    ...
    private void forwardMessage(ArrayList<Long> smsList) {
        ...
        for (int i = 0; i < smsList.size(); i++) {
            ...
            MmsLog.d(TAG,"forwardMessage  strbuf.length()="+strbuf.length()+"  tempbuf.length() = "+tempbuf.length());
        }
        if (reachLimitFlag) {

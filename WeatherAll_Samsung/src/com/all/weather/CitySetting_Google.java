...
public class CitySetting_Google extends Activity {
        ...
        city_listview1.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String[] str = new String[] {
                		CitySetting_Google.this.getResources().getString(R.string.delete_warning),
                		CitySetting_Google.this.getResources().getString(R.string.delete_message),
                		CitySetting_Google.this.getResources().getString(R.string.add_ok),
                		CitySetting_Google.this.getResources().getString(R.string.add_cancel)
                };
                final int pos = position;
                final TextView name = (TextView) view.findViewById(R.id.text1);
                String deletecity = name.getText().toString();
                new AlertDialog.Builder(CitySetting_Google.this).setTitle(str[0])
        ...
        city_listview1.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SettingsManager.getInstance().setLocationZipCode(
                        mCursor.getString(3), CitySetting_Google.this, false);
                SettingsManager.getInstance().setLocationCity(
                        mCursor.getString(1), CitySetting_Google.this, false);
                SettingsManager.getInstance().setLocationArea(
                        mCursor.getString(2), CitySetting_Google.this, false);
                    ...
                    return new AlertDialog.Builder(this)
                            ...
                            .setItems(items, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichcountry) {
                                    ...
                                    SettingsManager.getInstance().setLocationZipCode(
                                             ZIPCODE, CitySetting_Google.this,
                                            false);
                                    SettingsManager.getInstance().setLocationCity(
                                            CITYNAME, CitySetting_Google.this,
                                            false);
                                    SettingsManager.getInstance().setLocationArea(
                                            STATE, CitySetting_Google.this,
                                            false);
                                    // initListView();
                                    dialog.dismiss();
                                    finish();

...
public class CallLogListItemView extends ViewGroup implements SelectionBoundsAdjuster {
	...
	//GPBYB-354 liyang 20130922 start
    private static int DEFAULT_ITEM_TEXT_COLOR;  // default text color is white
	static {
        if (com.mediatek.common.featureoption.FeatureOption.RLK_GP818H_A1_SN_SUPPORT) {
			DEFAULT_ITEM_TEXT_COLOR = 0xFF000000;
		}else{
			DEFAULT_ITEM_TEXT_COLOR = 0xFFFFFFFF;
		}
	}
	//GPBYB-354 liyang 20130922 end
...
//        defLabelViewWidthWeight);
		...
		//GPBYB-354 liyang 20130922 start
        if (com.mediatek.common.featureoption.FeatureOption.RLK_GP818H_A1_SN_SUPPORT) {
			mSecondaryTextColor = DEFAULT_CALLLOG_SECONDARY_TEXT_COLOR;
		}else{
...
//            }
    ...
    public ImageView getCallButton() {
        if (null == mImageViewCall) {
            ...
            // GPBYB-272 shuchenlin begin
            if (com.mediatek.common.featureoption.FeatureOption.RLK_GP818H_A1_SN_SUPPORT) {
                //mImageViewCall.setImageResource(R.drawable.ic_ab_dialer_holo_dark);
                mImageViewCall.setImageResource(R.drawable.list_call_light);
            } else {
                mImageViewCall.setImageResource(R.drawable.ic_ab_dialer_holo_dark);
            }
            // GPBYB-272 shuchenlin end

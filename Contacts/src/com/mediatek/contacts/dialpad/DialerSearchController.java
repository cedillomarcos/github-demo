...
/** @ }*/
    ...
    public void onStart() {
        ...
        if (mIsFirstLaunched && mDigits.length() <= 0) {
            // if first launch,load all the data in Call log
            // but if the mDigits has text when first Launched,it indicates that
            // the dialer was launched by other apps' send like 'tel:xxxxxx'.
            forceLoadAll();
    ...
    public void onResume() {
        ...
        if (mConfigFromIntent) {
            if (mDigits != null && mDigitsFromIntent != null) {
                ...
                mDigits.setSelection(mDigitsFromIntent.length());
            }

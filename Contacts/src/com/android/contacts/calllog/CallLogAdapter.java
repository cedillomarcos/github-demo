  ...
  */
   ...
   */
    ...
    protected void bindView(View view, Cursor c, int count) {
        ...
        // c.getPosition() should be done before IntentProvider.getCallDetailIntentProvider()
        // because IntentProvider.getCallDetailIntentProvider() may move position of cursor
        ...
        // Important: cursor.moveCursor() is called in IntentProvider.getCallDetailIntentProvider(),
        //            so should not use c.getXXX to get information from cursor in this function,
        //            should use ContactInfo in this function
        itemView.setTag(
                IntentProvider.getCallDetailIntentProvider(
                        this, c.getPosition(), c.getLong(CallLogQuery.ID), count));
...
//cuinana  GPBYY-60 modify   contactInfo.lookupUri =null
            contactInfo.lookupUri = contactInfo.lookupUri;
            ...
            Log.i(TAG, "[bindView] i = " + i + " | isSdnContact : " + contactInfo.isSdnContact);
    ...
    /** M: New Feature RCS @{ */
        ...
        boolean reslut = ExtensionManager.getInstance().getCallListExtension().setExtentionIcon(
                number, ExtensionManager.COMMD_FOR_RCS);

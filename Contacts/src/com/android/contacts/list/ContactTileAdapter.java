...
public class ContactTileAdapter extends BaseAdapter {
    ...
    private void bindColumnIndices() {
        ...
        if (mDisplayType == DisplayType.GROUP_MEMBERS) {
            ...
            mPhoneSimIndex = GroupDetailQuery.CONTACT_INDICATE_PHONE_SIM_COLUMN_INDEX;
            ...
            // add by mediatek
            mPhoneSimIndex = ContactTileLoaderFactory.PHONE_INDICATE_PHONE_SIM;
    ...
    private ContactEntry createContactEntryFromCursor(Cursor cursor, int position) {
         ...
         */
        contact.indexSimOrPhone = cursor.getInt(mPhoneSimIndex);
    ...
    // The following lines are provided and maintained by Mediatek Inc.
//    private int mPhoneSimIndex = GroupDetailQuery.CONTACT_INDICATE_PHONE_SIM_COLUMN_INDEX;

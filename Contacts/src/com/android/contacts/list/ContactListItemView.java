...
/** @ }*/
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        ExtensionManager.getInstance().getContactDetailExtension().measureExtentionIcon(
    ...
    public TextView getNameTextView() {
        if (mNameTextView == null) {
			...
			//GPBYB-350 liyang 20130922 start
			if (com.mediatek.common.featureoption.FeatureOption.RLK_GP818H_A1_SN_SUPPORT) {
				mNameTextView.setTextColor(0xFF000000);
			}
			//GPBYB-350 liyang 20130922 end

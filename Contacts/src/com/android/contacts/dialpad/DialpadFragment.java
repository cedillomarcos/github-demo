    ...
    public void onResume() {
        ...
        if (mDialpadDivider != null) {
            ...
            if (com.mediatek.common.featureoption.FeatureOption.RLK_GP818H_A1_SN_SUPPORT) {
                mDialpadDivider.setVisibility(View.GONE);
            } else{
    ...
    private void showDialpadChooser(boolean enabled) {
        ...
        if (enabled) {
            ...
            if (ContactsApplication.sDialerSearchSupport) {
				...
				// GPBYL-337 chenbo modify 20130522 (start)
				final View right = fragmentView.findViewById(R.id.right);
				if (right != null) {
					right.setVisibility(View.GONE);
				}
				// GPBYL-337 chenbo modify 20130522 (end)
            }

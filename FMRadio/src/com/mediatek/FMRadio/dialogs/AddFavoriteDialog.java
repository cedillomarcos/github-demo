...
public class AddFavoriteDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final EditText editTextStationName = (EditText) v.findViewById(R.id.dlg_add_station_name_text);//jiayusheng GBLLSW-251 20130311 
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(R.string.btn_ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                    	...
                    	Log.d("AddFavoriteDialog", "onCreateDialog--->name: " + name);
                    	if(name != null){

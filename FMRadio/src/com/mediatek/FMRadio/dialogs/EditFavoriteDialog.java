...
public class EditFavoriteDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final EditText editTextStationName = (EditText) v.findViewById(R.id.dlg_edit_station_name_text);//jiayusheng GBLLSW-251 20130311 
        ...
        return new AlertDialog.Builder(getActivity())
			...
			if (0 == name.length()) {
                		Toast.makeText(context, R.string.toast_channel_name_empty, Toast.LENGTH_SHORT).show();
                		return;
                	}
                        if(FMRadioStation.hasDuplicateName(context, name)){
                        	return;
                        }
                        //jiayusheng GBLLSW-251 20130311 end

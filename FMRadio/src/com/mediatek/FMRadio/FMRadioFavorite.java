...
//MAOYUTAO GPBYL-105 20130515 start
import android.view.Menu;
import android.content.DialogInterface;
import android.app.AlertDialog;
//MAOYUTAO GPBYL-105 20130515 end
/**
...
public class FMRadioFavorite extends Activity implements LoaderCallbacks<Cursor>,
    ...
    //MAOYUTAO GPBYL-105 20130515 start
    private static final int CONTMENU_ID_DELETE_ITEM = 4; // content menu id add
    private static int CURRENT_CONTENT_ITEM_TYPE = 1;//current type
    //MAOYUTAO GPBYL-105 20130515 end
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLvFavorites.setOnCreateContextMenuListener(
            ...
            new View.OnCreateContextMenuListener() {
		     ...
		     //MAOYUTAO GPBYL-105 20130515 start 
                    CURRENT_CONTENT_ITEM_TYPE = stationType;
                    //MAOYUTAO GPBYL-105 20130515 end
			 ...
			 //MAOYUTAO GPBYL-105 20130515 start
                        menu.add(0, CONTMENU_ID_DELETE_ITEM, 0, mProjectStringExt.getProjectString(mContext, 
                                R.string.contmenu_item_delete_item, R.string.contmenu_item_delete_item1));
                        //MAOYUTAO GPBYL-105 20130515 end
                    } else {
                        // Favorite station.
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            break;
            //MAOYUTAO GPBYL-105 20130515 start
            case CONTMENU_ID_DELETE_ITEM:
            	AlertDialog dialog = new AlertDialog.Builder(this)
     			.setTitle(R.string.contmenu_item_delete_item)
     			.setMessage(R.string.contmenu_item_delete_item1)
     			.setPositiveButton(R.string.btn_ok,
     				new DialogInterface.OnClickListener() {
     					public void onClick(DialogInterface dialog, int which) {
     							FMRadioStation.deleteStationInDB(FMRadioFavorite.this,mDlgStationFreq,CURRENT_CONTENT_ITEM_TYPE);
    ...
    //MAOYUTAO GPBYL-105 20130515 start
    private static final int MENU_ID_DELETE_ALL = 1;

  	@Override
  	public boolean onCreateOptionsMenu(Menu menu) {
  		deleteAllItem = menu.add(0, MENU_ID_DELETE_ALL, 0, R.string.delete_all_channel);
  		deleteAllItem.setIcon(android.R.drawable.ic_delete);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //MAOYUTAO GPBYL-105 20130515 start
        if(item.getItemId() == MENU_ID_DELETE_ALL)
        {
        	final TextView emptyView = (TextView) findViewById(R.id.empty);
        	AlertDialog dialog = new AlertDialog.Builder(this)
 			.setTitle(R.string.delete_all_channel)
 			.setMessage(R.string.delete_all_channel_text)
 			.setPositiveButton(R.string.btn_ok,
 				new DialogInterface.OnClickListener() {
 					public void onClick(DialogInterface dialog, int which) {
 						if (FMRadioStation.deleteAll(FMRadioFavorite.this)) {
 							mLvFavorites.setEmptyView(emptyView);
 							mAdapter.notifyDataSetChanged();
 						}
 					}

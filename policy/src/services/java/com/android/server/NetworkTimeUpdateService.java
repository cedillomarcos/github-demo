...
public class NetworkTimeUpdateService {
    ...
    //add 20130604_maoyutao_GPBYL-536 START
    private static int mDefaultMon = 0;
    private static int mDefaultDay = 1;
    //add 20130604_maoyutao_GPBYL-536 END
    ...
    public void systemReady() {
        ...
        mDefaultYear  = mContext.getResources().getInteger(com.mediatek.internal.R.integer.default_restore_year);
				//modidy 20130604_maoyutao_GPBYL-536 START
       // mDefaultMon  = mContext.getResources().getInteger(com.mediatek.internal.R.integer.default_restore_mon);
       // mDefaultDay  = mContext.getResources().getInteger(com.mediatek.internal.R.integer.default_restore_day);
				//modidy 20130604_maoyutao_GPBYL-536 END
        ...
        if(isFirstBoot){
           ...
           if("".equals(decryptState) || DECRYPT_STATE.equals(decryptState)){
              ...
              today.set(mDefaultDay, mDefaultMon, mDefaultYear);
              //modidy 20130604_maoyutao_GPBYL-536 end      

...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (mScreenshotChordEnabled && (flags & KeyEvent.FLAG_FALLBACK) == 0) {
            if (mVolumeDownKeyTriggered && !mPowerKeyTriggered) {
                ...
                if (now < timeoutTime) {
					//renxinquan add log start
					Log.d(TAG,"renxinquan : ---- now < timeoutTime : now = "  +now + "time_out ="+timeoutTime);
					//renxinquan add log end
            ...
            if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN
				...
				//renxinquan add log start
				Log.d(TAG,"renxinquan -----  KEYCODE_VOLUME_DOWN");
				//renxinquan add log end
                return -1;
            }
        }
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            if (win != null && win.getAttrs() != null) {
                ...
                //renxinquan add log start
				Log.d(TAG,"renxinquan -----  flag & WindowManager.LayoutParams.FLAG_HOMEKEY_DISPATCHED");
				//renxinquan add log end
                    return 0;
                }
            }
            ...
            if (!down) {
				...
				//renxinquan add log start
				Log.d(TAG,"renxinquan -----  homeWasLongPressed = " +homeWasLongPressed);
				//renxinquan add log end
                if (!homeWasLongPressed) {
                    ...
                    if (!canceled) {
                        ...
                        if (incomingRinging) {
							...
							//renxinquan add log start
							Log.d(TAG,"renxinquan -----  launchHomeFromHotKey = " );
							//renxinquan add log end
	...
	//chenbo add (start)
	 void sendKey(int key) {
		Intent intent = null;
		android.util.Log.d("sendKey", ">>>>>>>>>> key : "+key);
		switch (key) {
		case KeyEvent.KEYCODE_POWER:
			android.util.Log.d("powerKey", ">>>>>>>>>> sendKey : powerkey");
		...
		case KeyEvent.KEYCODE_ENDCALL:
			android.util.Log.d("headsethook", ">>>>>>>>>> sendKey : headsethook");
    ...
    boolean isKeysTest() {
		...
		// GPBYL-487 chenbo 20130603 (start) 
		// add hall test
		if ("com.reallytek.wg.KeyTestActivity".equals(comName.getClassName())
	            || "com.reallytek.wg.HallTestActivity".equals(comName.getClassName())) {
			return true;
		} else {
			return false;
		}
		// GPBYL-487 chenbo 20130603 (end) 
    }

	boolean isEarphoneTest() {
    	ActivityManager am= (ActivityManager) mContext.getSystemService(Context.ACTIVITY_SERVICE);
		List<RunningTaskInfo> runningTasks = am.getRunningTasks(1);
		ComponentName comName = runningTasks.get(0).topActivity;
		android.util.Log.d("test", ">>>>>>>>>>>>>>>>> comName:"+comName.getClassName());
		if ("com.reallytek.wg.EarphoneTestActivity".equals(comName.getClassName())) {
			return true;
		} else {
			return false;
		}
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags, boolean isScreenOn) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_MEDIA_FAST_FORWARD: {
				// chenbo add start
				if (isEarphoneTest()) {
            		sendKey(KeyEvent.KEYCODE_HEADSETHOOK);
            	}
				// chenbo add end

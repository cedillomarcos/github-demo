...
/*GPBYY-56 shuchenlin begin*/
import java.util.Calendar;
/*GPBYY-56 shuchenlin end*/
...
public class KeyguardStatusView extends GridLayout {
    ...
    private KeyguardUpdateMonitorCallback mInfoCallback = new KeyguardUpdateMonitorCallback() {
        ...
        @Override
	//liyang MTK add int isTimeZoneChanged
        public void onTimeChanged(int isTimeZoneChanged) {
	    if(1 == isTimeZoneChanged) {
		Resources res = getContext().getResources();
        /*GPBYY-56 shuchenlin begin*/
		//mDateFormatString = res.getText(com.android.internal.R.string.abbrev_wday_month_day_year);
            mDateFormatString = android.provider.Settings.System.getString(getContext().getContentResolver(), android.provider.Settings.System.DATE_FORMAT);
            if(mDateFormatString == null) {
                mDateFormatString = "yyyy-MM-dd";
            }
         /*GPBYY-56 shuchenlin end*/
	    }
    ...
    protected void onFinishInflate() {
        ...
        /*GPBYY-56 shuchenlin begin*/
        //mDateFormatString =
        //        res.getText(com.android.internal.R.string.abbrev_wday_month_day_year);
        mDateFormatString = android.provider.Settings.System.getString(getContext().getContentResolver(), android.provider.Settings.System.DATE_FORMAT);
        if(mDateFormatString == null) {
             mDateFormatString = "yyyy-MM-dd";
        }
    ...
    void refreshDate() {
        /*GPBYY-56 shuchenlin begin*/
        maybeSetUpperCaseText(mDateView, (CharSequence)DateFormat.getDateFormatForSetting(getContext(), (String)mDateFormatString).format(Calendar.getInstance().getTime()));
        /*GPBYY-56 shuchenlin end*/
    }

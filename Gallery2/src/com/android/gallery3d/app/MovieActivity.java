...
//GPBYB-351 liyang 20130923 add start
import com.mediatek.gallery3d.video.ScreenModeManager;
//GPBYB-351 liyang 20130923 add end
...
public class MovieActivity extends Activity implements CreateBeamUrisCallback {
	...
	public void onConfigurationChanged(Configuration newConfig){
        ...
        MtkLog.d("liyang", "onConfigurationChanged");
		if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
			MtkLog.d("liyang", "portrait");
			ScreenModeManager mScreenModeManager = new ScreenModeManager();
			MovieControllerOverlay mController = new MovieControllerOverlay(MovieActivity.this);
			mScreenModeManager.setScreenMode(mScreenModeManager.getDefaultScreenMode());
			mController.show();
		}
	}
	//GPBYB-351 liyang 20130923 add end

...
/* History:
 * 1.yujie.huang@reallytek.com 20130401 BUG_ID:GBLLSW-449
 *   Description: the slide should be stoped if the screen is off
 */
...
// add BUG_ID:GBLSSW-449 huangyujie 20130401 (start)
import com.android.gallery3d.ui.GLRoot;
import android.content.BroadcastReceiver;
import android.content.Context;
import android.content.IntentFilter;
// add BUG_ID:GBLSSW-449 huangyujie 20130401 (end)
...
public class SlideshowPage extends ActivityState {
    ...
    // add BUG_ID:GBLSSW-449 huangyujie 20130401 (start)
        ...
        ((Activity) mActivity).registerReceiver(mScreenOffReceiver, filter);
    // add BUG_ID:GBLSSW-449 huangyujie 20130401 (end)
    }
...
// add BUG_ID:GBLSSW-449 huangyujie 20130401 (start)
    private BroadcastReceiver mScreenOffReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.v(TAG, "screen of onReceive(" + intent.getAction());
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        ((Activity) mActivity).unregisterReceiver(mScreenOffReceiver);
    }
// add BUG_ID:GBLSSW-449 huangyujie 20130401 (end)
    ...
    private void showPendingBitmap() {
        ...
        // 2.) mModel is paused
    	Log.v(TAG, "slidshow showPendingBitmap mPendingSlide" + mPendingSlide);

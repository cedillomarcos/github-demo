...
public class TrimTimeBar extends TimeBar {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!mShowTimes && !mShowScrubber) {
            ...
            mProgressBar.set(
                    /*GPBYB-46 shuchenlin begin*/
                    //getPaddingLeft() + margin, progressY,
                    //w - getPaddingRight() - margin, progressY + 4);
                    getPaddingLeft() + margin, progressY * 2,
                    w - getPaddingRight() - margin, progressY * 2 + 4);
                    /*GPBYB-46 shuchenlin end*/
        }
        update();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowScrubber) {
            ...
            canvas.drawBitmap(mScrubber, mScrubberLeft, mScrubberTop + mTrimStartScrubberTop, null);
            canvas.drawBitmap(mTrimStartScrubber, mTrimStartScrubberLeft,
                    mTrimStartScrubberTop * 2, null);
            canvas.drawBitmap(mTrimEndScrubber, mTrimEndScrubberLeft,
                    mTrimEndScrubberTop * 2, null);
		    /*GPBYB-46 shuchenlin end*/
        }
    }

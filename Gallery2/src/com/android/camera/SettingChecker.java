...
// add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
    public static final int ROW_SETTING_STORAGE = 51;//common
...
// modify BUG_ID:GBLLSW-551 20130322 huangyujie (start)
    ...
    public static final int SETTING_ROW_COUNT = 52;
...
//        ROW_SETTING_CONTRAST,//common
    ...
    public static final int[] SETTING_GROUP_ALL_IN_SETTING = new int[]{
        ...
        ROW_SETTING_GEO_TAG,//common not in parameter
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
        ROW_SETTING_STORAGE,//common not in parameter
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (end)
        //ROW_SETTING_AE_METER,
        ROW_SETTING_ANTI_FLICKER,//common
    ...
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
        MATRIX_MODE_STATE[ROW_SETTING_STORAGE]          = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//51: storage
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (end)
    ...
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
        MATRIX_SCENE_STATE[ROW_SETTING_STORAGE]           = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//51: storage
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (end)
		...
		//add GBLLSW-1134 hujiaxuan 20130408  
        RESET_STATE_VALUE[ROW_SETTING_STORAGE]    = new String[]{"/storage/sdcard1"};
    ...
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
        KEYS_FOR_SETTING[ROW_SETTING_STORAGE]           = CameraSettings.KEY_STORAGE_LOCATION;
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (end)
    ...
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
        MATRIX_SETTING_VISIBLE[CAMERA_BACK_ID][ROW_SETTING_STORAGE]    = true;
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (end)
    ...
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
        MATRIX_SETTING_VISIBLE[CAMERA_FRONT_ID][ROW_SETTING_STORAGE]    = true;
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (end)
    ...
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (start)
        DEFAULT_VALUE_FOR_SETTING_ID[ROW_SETTING_STORAGE]    = R.string.pref_camera_storage_location_default;
    // add BUG_ID:GBLLSW-551 20130322 huangyujie (end)
    }
    ...
    private static Point computeDesiredPreviewSize(Camera context, CamcorderProfile profile, Parameters parameters) {
        ...
        if (parameters.getSupportedVideoSizes() == null || context.effectsActive()) { //should be rechecked usedefault
            ...
            Size optimalSize = Util.getOptimalPreviewSize(context, sizes,
                    ...
                    !context.isVideoWallPaperIntent()); //don't change target ratio
            if (optimalSize != null) {
    ...
    public void turnOffWhenHide() {
        if (LOG) { //may open camera slow, so parameters may be null.
            Log.v(TAG, "turnOffWhenHide() mContext.getParameters()=" + mContext.getParameters());
        }
        setOverrideValues(ROW_SETTING_FLASH, Parameters.FLASH_MODE_OFF);
        if (mContext.getParameters() != null) {
            //mContext.getFocusManager().overrideFocusMode(Parameters.FOCUS_MODE_INFINITY);
            //mContext.getParameters().setFocusMode(mContext.getFocusManager().getFocusMode());
            setParameterValue(mContext, mContext.getParameters(), ROW_SETTING_FLASH, Parameters.FLASH_MODE_OFF);
    ...
    public void turnOnWhenShown() {
        if (LOG) { //may open camera slow, so parameters may be null.
            Log.v(TAG, "turnOnWhenShown() mContext.getParameters()=" + mContext.getParameters()
                    + ", mContext.getPreferences()=" + mContext.getPreferences());
        }
        setOverrideValues(ROW_SETTING_FLASH, null);
        if (mContext.getParameters() != null && mContext.getPreferences() != null) {
            //mContext.getFocusManager().overrideFocusMode(null);
            applyPreferenceToParameters(mContext, mContext.getPreferences(), mContext.getParameters(),

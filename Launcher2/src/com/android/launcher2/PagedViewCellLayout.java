...
public class PagedViewCellLayout extends ViewGroup implements Page {
    ...
    int getContentHeight() {
        if (mCellCountY > 0) {
//GPBYL-622 cuinana  return mCellCountY * mCellHeight + (mCellCountY - 1) * Math.max(0, mHeightGap);
            return mCellCountY * mCellHeight + (mCellCountY - 1) * Math.max(0, mHeightGap)+28;//cuinana GPBYY-26 
        }
        return 0;
    }

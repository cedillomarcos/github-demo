...
//renxinquan add start
				...
				String[] m={mContext.getString(R.string.default_sort),mContext.getString(R.string.a_sort),mContext.getString(R.string.time_sort)};
				adapter = new ArrayAdapter<String>(mContext,android.R.layout.simple_spinner_item,m);
				adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
				spinner.setAdapter(adapter);
				spinner.setSelection(Launcher.getSortType(mContext),true);
...
//renxinquan add start
    ...
    class SpinnerSelectedListener implements OnItemSelectedListener{  
        ...
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,  
            ...
            Intent intent = new Intent("SuNing_app_sort");
    			  mContext.sendBroadcast(intent);
            Launcher.setSortType(arg2,mContext);
        }  
...
//renxinquan add end
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//GPBYL-554 20130605 ADD
		mTabs.getLayoutParams().width = mTabs.getLayoutParams().width + 30;
		//GPBYL-554 20130605 ADD
            ...
            public void run() {
                ...
                for (int i = visiblePages.size() - 1; i >= 0; i--) {
					...
					if (FeatureOption.RLK_GP818H_A1_SN_SUPPORT){
						mAnimationBuffer.setBackgroundColor(Color.TRANSPARENT);
					}
    ...
    //zhuwei add
    public boolean onUninstallStateChanged(boolean state) {
    	if (mTabs == null || mTabsContainer == null) {
    		return false;
    	}
    	mTabs.setEnabled(!state);
    	mTabs.setClickable(!state);
    	mTabsContainer.setEnabled(!state);
    	mTabsContainer.setClickable(!state);
    	View shopButton = findViewById(R.id.market_button);
    	//View themeButton = findViewById(R.id.theme_button);
    	if (shopButton != null) {
    		shopButton.setEnabled(!state);
    		shopButton.setClickable(!state);
    	}
    	//if (themeButton != null) {
    	//	themeButton.setEnabled(!state);
    	//	themeButton.setClickable(!state);
    	//}
    	return true;
    }
    //end

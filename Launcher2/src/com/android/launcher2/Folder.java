...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    protected boolean createAndAddShortcut(ShortcutInfo item) {
        ...
        //add zhaojiangwei test
    	if (false){
    	    boolean inPowerMode = Settings.Global.getInt(mLauncher.getContentResolver(), Settings.Global.POWER_MODE_ON, 0) != 0;
    	    String packageName = item.getPackageName();
    	    Bitmap bitmap = item.getIcon(mIconCache);
    	    if ("com.android.browser".equals(packageName) && inPowerMode){		
    	    	bitmap = Utilities.drawDisabledBitmap(bitmap,mLauncher);
    	    }
	    shortcut.setIcon(new FastBitmapDrawable(bitmap)); 
    	} else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /*GPBYB-229 shuchenlin begin*/
        mFolderName.measure(contentWidthSpec,
                MeasureSpec.makeMeasureSpec(mFolderNameHeight, MeasureSpec.EXACTLY));
        /*GPBYB-229 shuchenlin end*/
